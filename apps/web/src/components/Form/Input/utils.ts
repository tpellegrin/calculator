...
/**
 * Returns the effective maximum fraction digits given the input format and
 * an optional override. Defaults to 0 (integer-only) when no override is set.
 */
export const getEffectiveMaxFractionDigits = (
  _format: 'number' | undefined,
